...
//AWSGOVRegions The 2 regions Dome9 manages in AWSGOV cloud account
var AWSGOVRegions = []string{"us_gov_west_1", "us_gov_east_1"}
//AWSChinaRegions The 2 regions Dome9 manages in AWSChina cloud account
var AWSChinaRegions = []string{"cn_northwest_1", "cn_north_1"}
// The 23 regions Dome9 manages in AWS & AWSGOV &AWSCHINA cloud account
var AllAWSRegions = append(append(AWSGOVRegions, AWSRegions...), AWSChinaRegions...)
