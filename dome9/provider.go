	...
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			*/
			...
			resourcetype.CloudAccountAWSSecurityGroupRole: resourceCloudSecurityGroupAWSRole(),
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			resourcetype.CloudAccountAWSSecurityGroupRole: dataSourceCloudSecurityGroupAWSRole(),
