...
func Provider() terraform.ResourceProvider {
	return &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			resourcetype.AwsUnifiedOnbordingUpdateVersionStackConfig: dataSourceAwsUnifiedOnboardingUpdateVersionStackConfig(),
			resourcetype.AwsUnifiedOnbording:                         dataSourceAwsUnifiedOnboarding(),
