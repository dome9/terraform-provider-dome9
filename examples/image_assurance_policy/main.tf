...
data "dome9_image_assurance_policy" "image_assurance_policy_test" {
  id = dome9_image_assurance_policy.image_assurance_policy_test.id
}

output "getPolicyId" {
  value = dome9_image_assurance_policy.image_assurance_policy_test.id
}

output "getTargetId" {
  value = dome9_image_assurance_policy.image_assurance_policy_test.target_id
}

output "getAdmissionControlAction" {
  value = dome9_image_assurance_policy.image_assurance_policy_test.admission_control_action
}

output "getAdmissionControlUnScannedAction" {
  value = dome9_image_assurance_policy.image_assurance_policy_test.admission_control_unscanned_action
}
